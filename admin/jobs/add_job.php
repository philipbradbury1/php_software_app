...
if(isset($_POST['add-job-form-submit'])){
	...
	$validate = new ValidationSet($_POST);
...
/*
	...
	$vehicle->vehicle_reg = $reg;
	$vehicle->vehicle_make = $make;
	$vehicle->vehicle_model = $model;
	$vehicle->vehicle_colour = $color;
	$vehicle->vehicle_type = $style;
								...
								<form id="register-form" name="register-form" class="nobottommargin" action="#" method="post">
									...
									<div class="row mb-5">
										...
										<div class="col-4 mb-1">
											...
											<select id="add-job-form-style" name="add-job-form-style" class="form-control">
												<option value=""  hidden>Select Style</option>
